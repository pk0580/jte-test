...
Разберём основы SOAP, WSDL, структуру SOAP-сообщений, а затем посмотрим, как это реализовано в проекте, как сформировать корректный запрос и получить ответ, как тестировать и отлаживать интеграции.
