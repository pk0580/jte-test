...
final class Version20260312102308 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE outbox_events (id INT AUTO_INCREMENT NOT NULL, event_type VARCHAR(255) NOT NULL, payload JSON NOT NULL, created_at DATETIME NOT NULL, scheduled_at DATETIME NOT NULL, processed_at DATETIME DEFAULT NULL, attempts INT NOT NULL, last_error LONGTEXT DEFAULT NULL, INDEX idx_outbox_process_lookup (processed_at, attempts), INDEX idx_outbox_scheduled_at (scheduled_at), INDEX idx_outbox_created_at (created_at), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
